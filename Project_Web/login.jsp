                    ...
                    <form action="DangNhap" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="SoTK" class="form-control" placeholder="Nhập số tài khoản" pattern="[0-9]{8}"
                                title="Số tài khoản phải đủ có 8 chữ số" required value="${TaiKhoan}" />
                        </div>
                        <div class="form-group">
                            <label>Mật khẩu</label> 
                            <input type="password" name="Matkhau" class="form-control" placeholder="Mật khẩu" minlength="6" maxlength="6" title="Mẩu khẩu phải đúng 6 ký tự" required>
                        </div>
